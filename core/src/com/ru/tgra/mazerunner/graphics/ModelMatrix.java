...
public class ModelMatrix extends Matrix {
	...
	public void addRotationX(float angle)
	{
		...
		MMtmp[1] = 0; MMtmp[5] = (float)Math.cos(angle); MMtmp[9] = (float)-Math.sin(angle); MMtmp[13] = 0;
		MMtmp[2] = 0; MMtmp[6] = (float)Math.sin(angle); MMtmp[10] = (float)Math.cos(angle); MMtmp[14] = 0;
	...
	public void addRotationY(float angle)
	{
		...
		MMtmp[0] = (float)Math.cos(angle); MMtmp[4] = 0; MMtmp[8] = (float)Math.sin(angle); MMtmp[12] = 0;
		MMtmp[1] = 0; MMtmp[5] = 1; MMtmp[9] = 0; MMtmp[13] = 0;
		MMtmp[2] = (float)-Math.sin(angle); MMtmp[6] = 0; MMtmp[10] = (float)Math.cos(angle); MMtmp[14] = 0;
		MMtmp[3] = 0; MMtmp[7] = 0; MMtmp[11] = 0; MMtmp[15] = 1;
